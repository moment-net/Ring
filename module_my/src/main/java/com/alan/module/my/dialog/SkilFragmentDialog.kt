...
import com.alan.module.my.viewmodol.SkilViewModel
...
@AndroidEntryPoint
class SkilFragmentDialog : BaseFrameDialogFragment<LayoutDialogSkilBinding, SkilViewModel>() {


    /**
     * 通过 viewModels() + Hilt 获取 ViewModel 实例
     */
    override val mViewModel by viewModels<SkilViewModel>()
    private lateinit var mAdapter: SkilAdapter

    override fun LayoutDialogSkilBinding.initView() {
        tvTitle.setText("职业技能")
